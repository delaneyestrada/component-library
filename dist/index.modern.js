...
function ImageGallery({
  ...
  return React.createElement("div", null, React.createElement("div", {
    ...
    if (image.galleryImage.childImageSharp) {
      const imageJpg = image.galleryImage.childImageSharp.gatsbyImageData.images.fallback;
      const imageWebp = image.galleryImage.childImageSharp.gatsbyImageData.images.sources[0];
  ...
  })), lightboxOpen && React.createElement(Lightbox, {
    mainSrc: lightboxImg,
...
function TourSection({
  ...
  return React.createElement(React.Fragment, null, React.createElement(HelmetExport, null, React.createElement("script", {
    charSet: 'utf-8',
...
function ShopifyShop() {
  ...
  return React.createElement("div", null, React.createElement("div", {
    ...
    }, React.createElement("h2", null, collection.title), collection.products.map(product => {
      return React.createElement("div", {
        key: product.id
      }, product.title);
    }));
...
export { TourSection as BandsintownWidget, ImageGallery, ShopifyShop, SpotifyPlayer };
