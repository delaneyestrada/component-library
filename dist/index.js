...
var ShopifyBuy = _interopDefault(require('@shopify/buy-button-js'));

var SpotifyPlayer = function SpotifyPlayer(_ref) {
  var url = _ref.url,
      height = _ref.height;
...
function ImageGallery(_ref) {
  ...
  var _useState = React.useState(''),
      lightboxImg = _useState[0],
      setLightboxImg = _useState[1];

  var _useState2 = React.useState(false),
      lightboxOpen = _useState2[0],
      setLightboxOpen = _useState2[1];

  var openLightbox = function openLightbox(imgSrc) {
  ...
  return React__default.createElement("div", null, React__default.createElement("div", {
    ...
    if (image.galleryImage.childImageSharp) {
      var imageJpg = image.galleryImage.childImageSharp.gatsbyImageData.images.fallback;
      var imageWebp = image.galleryImage.childImageSharp.gatsbyImageData.images.sources[0];
      return React__default.createElement("picture", null, React__default.createElement("source", {
        srcSet: imageWebp.srcSet,
        sizes: imageWebp.sizes
      }), React__default.createElement("img", {
        alt: image.galleryImage.name,
        src: imageJpg.src,
        onClick: function onClick() {
          return openLightbox(imageJpg.src);
        }
      }));
    } else {
      return '';
    }
  })), lightboxOpen && React__default.createElement(Lightbox, {
    mainSrc: lightboxImg,
...
function TourSection(_ref) {
  var bandsintownWidgetData = _ref.bandsintownWidgetData;
  return React__default.createElement(React__default.Fragment, null, React__default.createElement(HelmetExport, null, React__default.createElement("script", {
    charSet: 'utf-8',
...
function ShopifyShop() {
  ...
  React.useEffect(function () {
    shopifyClient.collection.fetchAllWithProducts().then(function (collections) {
...
exports.BandsintownWidget = TourSection;
exports.ImageGallery = ImageGallery;
exports.ShopifyShop = ShopifyShop;
